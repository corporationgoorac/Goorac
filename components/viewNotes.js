...
class ViewNotes extends HTMLElement {
    ...
    // Handles Hardware Back Button on Mobile
    ...
    render() {
        ...
        <style>
            ...
            .vn-heart-btn { 
                background: #3a3a3c; border: none; width: 40px; height: 40px;
    ...
    async open(noteData, isOwnNote = false) {
        ...
        // Push history state to enable Back Button closing
    ...
    close() {
        // UI close triggers history back, which triggers internalClose via popstate
