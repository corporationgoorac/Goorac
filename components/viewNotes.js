...
class ViewNotes extends HTMLElement {
    ...
    async open(noteData, isOwnNote = false) {
        ...
        // 3. Push History State (Mobile Back Button)
        ...
        // 5. Fetch Fresh User Data (Profile, Verified Badge)
        try {
    ...
    updateContent(note, isOwn, userData) {
        ...
        // Data Fallbacks (Use fresh userData if available, otherwise note snapshot)
        ...
        content.innerHTML = `
            <div class="vn-header-profile">
                <div class="vn-pfp-ring" style="border-color:${isOwn ? '#555' : '#0095f6'}">
    ...
    loadMutualNotes: async function(user) {
        ...
        try {
            ...
            allNotes.forEach(note => {
                ...
                div.onclick = () => {
                    const viewer = document.querySelector('view-notes');
                    // Nav hiding is handled inside open()
